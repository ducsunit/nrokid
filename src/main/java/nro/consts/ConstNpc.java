...
public class ConstNpc {
    ...
    public static final String INFOR_TRAIN_OFFLINE = "Tập luyện vẫn tiếp tục và sức mạnh vẫn tăng khi Offline\n"
            + "Hiệu quả tập luyện như sau:\b"
            + "Yajirô: 5000 sức mạnh mỗi phút\b"
            + "Mr.PôPô: 10000 sức mạnh mỗi phút\b"
            + "Thượng đế: 20000 sức mạnh mỗi phút\b"
            + "Khỉ Bubbles: 40000 sức mạnh mỗi phút\b\n"
            + "Thần Vũ trụ: 80000 sức mạnh mỗi phút\b"
            + "Tổ sư Kaio: 120000 sức mạnh mỗi phút\b"
            + "Thiên sứ Whis: 240000 sức mạnh mỗi phút\b"
            + "Thần Hủy Diệt Bill: 500000 sức mạnh mỗi phút\b\n"
            + "Nếu đăng ký tập thường xuyên mỗi khi Offline thì không cần đến đây vẫn tập luyện được";
    ...
    public static final String HUONG_DAN_DOI_SKH_VIP = "Nguyên liệu cần để làm SKH VIP là :\n"
            ...
            + "Ví dụ nguyên liệu gồm : Quần Xayda Hủy diệt + 2 món Hủy diệt ngẫu nhiên\n"
    ...
    public static final int QUY_DOI_HN = 5030;
    public static final int QUY_DOI_TV = 5040;
    public static final int QUY_DOI_XU = 5041;
    public static final int TAIXIU = 5042;
    ...
    public static final int MENU_NANG_DOI_SKH_VIP = 508;
    ...
    public static final int MENU_TD_HD = 526;
    public static final int MENU_NM_HD = 527;
    public static final int MENU_XD_HD = 528;

    public static final int MENU_TD_TL = 529;
    public static final int MENU_NM_TL = 530;
    public static final int MENU_XD_TL = 531;

    public static final int MENU_OPTION_USE_ITEM1105 = 1105;
    public static final int MENU_OPTION_USE_ITEM1537 = 1559; // đồ kh huỷ diệt
    public static final int MENU_OPTION_USE_ITEM1538 = 1558; // đồ kh thần linh
    ...
    public static final int SHOP_SANTA_6 = 525;
