        ...
        try {
            ...
            try {
                if (rs.next()) {
                    ...
                    plMp = Long.parseLong(dataArray.get(12).toString());
                    dataArray.clear();
                    ...
                    int timeBienhinh = Integer.parseInt(String.valueOf(dataArray.get(7)));
                    ...
                    player.itemTimesieucap.lastTimeBienhinh = System.currentTimeMillis() - (ItemTimeSieuCap.TIME_ITEM_SC_10P - timeBienhinh);
